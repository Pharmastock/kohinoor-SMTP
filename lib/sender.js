...
class Sender extends EventEmitter {
    ...
    getConnection(delivery, done) {
        ...
        let tryConnect = () => {
            ...
            let zoneAddress = '43.249.233.137' || delivery.zoneAddress || delivery.zoneAddressIPv4;
            if (this.zone.preferIPv6 && delivery.zoneAddressIPv6) {
                zoneAddress = delivery.zoneAddressIPv6;
            }
            console.log('zoneAddress', zoneAddress)
            ...
            console.log('mxOptions', mxOptions)
            if (delivery.mx) {
